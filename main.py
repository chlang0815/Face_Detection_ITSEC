...
class HaarCascade():
    def __init__(self,data_set_path="./data/Celeb-real", scaleFactor = 1.3, minNeighbors = 5, number_of_videos = 2) -> None:
...
if __name__ == '__main__':
    ...
    hcr = HaarCascade(data_set_celb_real_dir)
    print(hcr.haar_cascade_classifier_result_dic)
